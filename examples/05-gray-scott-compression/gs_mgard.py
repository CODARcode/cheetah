    ...
    sweeps = [
     p.SweepGroup(name="gsc",
                  ...
                  component_inputs={
                      ...
                      'compression': ['adios2.xml','sz.config','zc.config','mgard.config']
                  },
      parameter_groups=
      [p.Sweep([
          ...
          p.ParamCmdLineArg("compression", "compressor", 3, ["3"]),          
          p.ParamKeyValue("compression", "tolerance", "mgard.config", "tolerance", [1.E-8, 1.E-3, 1.E-1]),
